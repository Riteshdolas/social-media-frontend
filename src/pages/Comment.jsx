  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="h-[90vh] w-full overflow-hidden md:h-full md:w-[50%]">
            <img
          ...
          <div className="h-full flex flex-col justify-between w-full md:w-[50%] text-[#f5f5f5] bg-[#1c1c1e]">
            <div className="p-5 text-xl">{username}</div>
